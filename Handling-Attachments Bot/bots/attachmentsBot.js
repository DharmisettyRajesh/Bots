...
class AttachmentsBot extends ActivityHandler {
    ...
    async displayOptions(turnContext) {
        ...
        const buttons = [
            { type: ActionTypes.ImBack, title: '1. Inline Attachment', value: 'hello' },
            { type: ActionTypes.ImBack, title: '2. Internet Attachment', value: 'Hello' },
            { type: ActionTypes.ImBack, title: '3. Uploaded Attachment', value: 'hello' }
        ];
